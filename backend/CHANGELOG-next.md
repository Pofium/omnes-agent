...
- Apply feature-gated Linux Landlock restrictions in the spawned child rather than restricting the OmnesAgent daemon, with scoped workspace and system access and fail-closed required paths (#9233, #9114).
...
- **Known advisory posture:** RUSTSEC-2026-0222 remains waived for Wasmtime 45.0.3 because OmnesAgent uses one process-wide engine and does not expose the advisory's cross-engine store precondition. The dependency upgrade remains tracked separately (#9586, #8519).
...
**Full diff:** https://github.com/omnesagent-labs/omnesagent/compare/v0.8.3...v0.8.4
