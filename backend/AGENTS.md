...
- User-facing runtime CLI, tool, and onboarding text uses Fluent keys through `omnesagent_runtime::i18n::{get_required_cli_string, get_required_cli_string_with_args}` rather than bare literals; see `crates/omnesagent-runtime/src/i18n.rs`.
