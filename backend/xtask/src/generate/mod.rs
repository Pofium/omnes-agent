...
fn registry() -> Vec<Surface> {
    vec![
        ...
        Surface {
            ...
            file: "crates/omnesagent-runtime/src/generated_locales.rs",
            render: runtime_locales::render_file,
        },
        Surface {
            name: "tools-en-ftl",
            file: "crates/omnesagent-tools/locales/en/tools.ftl",
        ...
        Surface {
            name: "scoop",
            file: "dist/scoop/omnesagent.json",
        ...
        Surface {
            ...
            file: "apps/omnescode/src/generated_themes.rs",
