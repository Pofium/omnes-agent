//! HTTP client for communicating with the OmnesAgent gateway.
...
mod tests {
    ...
    fn client_custom_url() {
        let client = GatewayClient::new("https://omnesagent.example.com:9999", None);
        assert_eq!(client.base_url, "https://omnesagent.example.com:9999");
    }
