...
## Definitions to delete (crates/omnesagent-config/src/schema.rs)
...
## Call sites to fix
- `crates/omnesagent-gateway/src/lib.rs` — 4 usages (lines ~489, ~490, ~647, ~2136)
- `crates/omnesagent-providers/src/lib.rs` — fallback logic, multiple usages (~660, ~715, ~724, ~753)
- `crates/omnesagent-runtime/src/agent/loop_.rs` — temperature lookup (~4598)
...
- crates/omnesagent-config/src/providers.rs
- crates/omnesagent-providers/src/lib.rs
- crates/omnesagent-gateway/src/lib.rs, api.rs, api_onboard.rs, ws.rs
- crates/omnesagent-channels/src/orchestrator/mod.rs, acp_server.rs
- crates/omnesagent-runtime/src/agent/agent.rs, loop_.rs
- crates/omnesagent-runtime/src/daemon/mod.rs, doctor/mod.rs, onboard/mod.rs, rpc/dispatch.rs, tools/mod.rs
- crates/omnesagent-tools/src/model_routing_config.rs
