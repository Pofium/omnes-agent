...
//! helpers live in `omnesagent-config`. Everything the binary needs (schema,
...
pub use omnesagent_config::migration;
pub use omnesagent_config::providers;
pub mod schema;
pub mod traits;
...
// without reaching into `omnesagent_config::schema` directly.
pub use schema::{
...
// Property helpers — single source of truth in omnesagent-config.
#[cfg(feature = "schema-export")]
pub use omnesagent_config::helpers::enum_variants;
pub use omnesagent_config::helpers::{
