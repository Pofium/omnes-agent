...
use omnesagent::plugins::PluginManifest;
pub(crate) use omnesagent::plugins::registry::search_entries;
use omnesagent::plugins::registry::{
...
pub(crate) const DEFAULT_REGISTRY_URL: &str =
    "https://raw.githubusercontent.com/omnesagent-labs/omnesagent-plugins/main/registry.json";
pub(crate) const MAX_PLUGIN_ZIP_BYTES: usize = 50 * 1024 * 1024;
pub(crate) const MAX_PLUGIN_EXTRACTED_BYTES: u64 = 50 * 1024 * 1024;
const REGISTRY_URL_ENV: &str = "OMNESAGENT_PLUGIN_REGISTRY_URL";
...
"#,
    ...
    fn rejects_registry_entry_manifest_identity_mismatch() {
        ...
        let manifest = PluginManifest {
            ...
            author: None,
            wasm_path: None,
            capabilities: vec![omnesagent::plugins::PluginCapability::Tool],
            permissions: Vec::new(),
            config_schema: None,
            signature: None,
            publisher_key: None,
            egress: omnesagent::plugins::PluginEgressDeclaration::default(),
        };
