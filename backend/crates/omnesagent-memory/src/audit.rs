...
impl<M: Memory> ::omnesagent_api::attribution::Attributable for AuditedMemory<M> {
...
impl<M: Memory> AuditedMemory<M> {
    ...
    fn log_audit(
        ...
        ::omnesagent_log::record!(
            INFO,
            ::omnesagent_log::Event::new(module_path!(), ::omnesagent_log::Action::MemoryAudit)
...
mod tests {
    ...
    async fn audited_ops_emit_memory_audit_events_via_bridge() {
        ...
        use omnesagent_api::observability_traits::{Observer, ObserverEvent, ObserverMetric};
        ...
        ::omnesagent_log::set_observer_bridge(observer.clone());
        audited
            .store("bridge_key", "v", MemoryCategory::Core, None)
            .await
            .unwrap();
        ::omnesagent_log::clear_observer_bridge();
