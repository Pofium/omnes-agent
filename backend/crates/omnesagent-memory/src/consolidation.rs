...
mod tests {
    ...
    use omnesagent_config::schema::{MemoryDedupAction, MemoryPolicyConfig, MemoryTypesConfig};
    ...
    impl ::omnesagent_api::attribution::Attributable for RecordingMemory {
...
mod consolidate_turn_tests {
    ...
    use omnesagent_config::schema::MemoryDedupAction;
