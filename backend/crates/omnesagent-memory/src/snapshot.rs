...
const SNAPSHOT_HEADER: &str = "# 🧠 OmnesAgent Memory Snapshot\n\n\
    > Auto-generated by OmnesAgent. Do not edit manually unless you know what you're doing.\n\
...
pub fn hydrate_from_snapshot(workspace_dir: &Path) -> Result<usize> {
    ...
    let default_agent_id = omnesagent_config::schema::v2::sqlite_ensure_default_agent_uuid(&tx)?;
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 OmnesAgent Memory Snapshot

> Auto-generated by OmnesAgent.
...
I am OmnesAgent, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 OmnesAgent Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
...
"#;
    ...
    fn hydrate_skips_snapshot_when_live_row_arrives_after_admission() {
        ...
        let default_agent_id =
            omnesagent_config::schema::v2::sqlite_ensure_default_agent_uuid(&conn).unwrap();
        let now = Local::now().to_rfc3339();
        conn.execute(
            "INSERT INTO memories (
                id, key, content, category, created_at, updated_at, agent_id
