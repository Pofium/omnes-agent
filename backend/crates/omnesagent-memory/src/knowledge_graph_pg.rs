...
mod tests {
    ...
    async fn bounded_executor_admits_one_operation_per_graph_instance() {
        ...
        let first = omnesagent_spawn::spawn!(run_bounded(first_gate, move || {
        ...
        let second = omnesagent_spawn::spawn!(run_bounded(second_gate, move || {
    ...
    fn postgres_test_url() -> String {
        std::env::var("OMNESAGENT_TEST_POSTGRES_URL")
