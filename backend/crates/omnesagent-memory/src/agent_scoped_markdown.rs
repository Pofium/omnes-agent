    ...
    async fn recall(
        ...
        for peer in &self.peers {
                ...
                .await
            {
                ...
                Err(error) => ::omnesagent_log::record!(
                    WARN,
...
impl ::omnesagent_api::attribution::Attributable for AgentScopedMarkdownMemory {
    fn role(&self) -> ::omnesagent_api::attribution::Role {
        ::omnesagent_api::attribution::Role::Memory(
            ::omnesagent_api::attribution::MemoryKind::AgentScopedMarkdown,
        )
    }
    fn alias(&self) -> &str {
        &self.own_alias
