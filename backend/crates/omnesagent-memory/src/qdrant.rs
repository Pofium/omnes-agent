...
impl QdrantMemory {
    pub async fn new(
        ...
        if mem.embedder.read().dimensions() > 0 {
            ...
            omnesagent_config::schema::v2::migrate_qdrant_collection_to_v3(
                &mem.client,
                &mem.base_url,
                &mem.collection,
    ...
    pub fn new_lazy(
        ...
        let client = omnesagent_config::schema::build_runtime_proxy_client("memory.qdrant");
...
impl ::omnesagent_api::attribution::Attributable for QdrantMemory {
    fn role(&self) -> ::omnesagent_api::attribution::Role {
        ::omnesagent_api::attribution::Role::Memory(::omnesagent_api::attribution::MemoryKind::Qdrant)
    }
    fn alias(&self) -> &str {
        &self.alias
    }
