...
/// Emit a structured OmnesAgent log event. The single positional `Event`
...
macro_rules! attribution_span {
    ($attributable:expr) => {{
        ...
        let __zc_role = $crate::__private::omnesagent_api::attribution::Attributable::role(__zc_thing);
        let __zc_alias = $crate::__private::omnesagent_api::attribution::Attributable::alias(__zc_thing);
