...
pub struct OmnesagentAttribution {
...
pub struct LogEvent {
    ...
    #[serde(default)]
    pub omnesagent: OmnesagentAttribution,
...
impl LogEvent {
    ...
    pub fn new(severity: Severity, action: &str, category: EventCategory) -> Self {
        Self {
            ...
            trace_id: None,
            span_id: None,
            omnesagent: OmnesagentAttribution::default(),
            message: None,
...
mod tests {
    ...
    fn merge_from_fills_missing_only() {
        let mut child = OmnesagentAttribution::default();
        child.set("agent_alias", "clamps");
        let mut parent = OmnesagentAttribution::default();
