...
use crate::event::OmnesagentAttribution;
    ...
    fn format_event(
        ...
        let label = ctx.event_scope().and_then(|scope| {
            ...
            for span in scope {
                ...
                let Some(attribution) = extensions.get::<OmnesagentAttribution>() else {
                    continue;
                };
...
mod tests {
        ...
        tracing::subscriber::with_default(subscriber, || {
            {
                ...
                tracing::info!(
                    target: "omnesagent_log_internal_test",
    ...
    const DYNAMIC_TARGET_PAYLOAD: &str = "omnesagent_dynamic_target_marker";
    const DYNAMIC_MODULE_PAYLOAD: &str = "omnesagent_dynamic_module_marker";
    const DYNAMIC_FILE_PAYLOAD: &str = "omnesagent_dynamic_file_marker";
    ...
    const SECRET_TARGET_PAYLOAD: &str = "sk_live_omnesagent_marker_token";
    const NAME_TARGET_PAYLOAD: &str = "OmnesagentDynamicNameMarker";
