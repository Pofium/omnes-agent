...
mod component {
    ...
    use exports::omnesagent::plugin::channel::{
        ApprovalRequest, ApprovalResponse, ChannelCapabilities, Guest as Channel, InboundMessage,
        SendMessage,
    };
    use exports::omnesagent::plugin::plugin_info::Guest as PluginInfo;
    use omnesagent::plugin::config::{ConfigError, get as config_get};
    use omnesagent::plugin::secrets::{SecretError, get as secret_get};
    ...
    impl Channel for FixtureChannel {
        ...
        fn poll_message() -> Option<InboundMessage> {
            let message = omnesagent::plugin::inbound::inbound_poll()?;
