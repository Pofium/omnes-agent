//! Channel adapter: `WasmChannel` implements `omnesagent_api::channel::Channel`
...
use crate::component::bindings::channel::exports::omnesagent::plugin::channel::{
            ...
            match polled {
                ...
                Err(e) => {
                    ...
                    ::omnesagent_log::record!(
                        WARN,
                        ::omnesagent_log::Event::new(module_path!(), ::omnesagent_log::Action::Inbound)
