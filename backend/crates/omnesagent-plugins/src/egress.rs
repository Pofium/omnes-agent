...
//! the post-resolution SSRF verdict all live in `omnesagent_infra::net_guard`,
...
use omnesagent_infra::net_guard::{
...
impl EgressPolicy {
    ...
    /// (`omnesagent_infra::net_guard::normalize_egress_pattern`): exact hosts or
