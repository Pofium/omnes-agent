...
use omnesagent_api::channel::{Channel, RoomCreationOptions, RoomVisibility};
...
mod tests {
    ...
    use omnesagent_api::channel::{ChannelMessage, SendMessage};
    ...
    impl ::omnesagent_api::attribution::Attributable for MockChannel {
