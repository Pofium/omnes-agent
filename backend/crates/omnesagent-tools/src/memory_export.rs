...
use omnesagent_memory::traits::ExportFilter;
use omnesagent_memory::{Memory, MemoryCategory};
...
fn entry_matches_filter(entry: &omnesagent_memory::MemoryEntry, filter: &ExportFilter) -> bool {
...
mod tests {
    ...
    use omnesagent_config::schema::MemoryPolicyConfig;
    use omnesagent_memory::{ScannedMemory, SqliteMemory};
