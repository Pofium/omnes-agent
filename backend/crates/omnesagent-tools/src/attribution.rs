...
use omnesagent_api::attribution::{ToolKind, ToolProvenance};
use omnesagent_api::tool_attribution;
...
use crate::dream_tool::DreamTool;
...
use crate::memory_feedback::MemoryFeedbackTool;
use crate::memory_forget::MemoryForgetTool;
use crate::memory_merge::MemoryMergeTool;
...
use crate::project_code::ProjectCodeTool;
use crate::project_intel::ProjectIntelTool;
use crate::proxy_config::ProxyConfigTool;
use crate::pushover::PushoverTool;
use crate::ralph_tool::{
    RalphContextTool, RalphIterationTool, RalphReportTool, RalphStartTool, RalphVerdictTool,
};
...
tool_attribution!(MemoryFeedbackTool, ToolKind::Memory);
tool_attribution!(MemoryForgetTool, ToolKind::Memory);
tool_attribution!(MemoryMergeTool, ToolKind::Memory);
...
tool_attribution!(RalphStartTool, ToolKind::Plugin);
tool_attribution!(RalphIterationTool, ToolKind::Plugin);
tool_attribution!(RalphVerdictTool, ToolKind::Plugin);
tool_attribution!(RalphContextTool, ToolKind::Plugin);
tool_attribution!(RalphReportTool, ToolKind::Plugin);
...
mod tests {
    ...
    use crate::calculator::CalculatorTool;
    use omnesagent_api::attribution::{Attributable, Role, ToolProvenance};
    ...
    fn mcp_wrapper_is_an_extension_even_when_its_role_is_plugin() {
        ...
        let tool = McpToolWrapper::new(
            ...
            Arc::new(registry),
            Arc::new(omnesagent_config::policy::SecurityPolicy::default()),
        );
        assert_eq!(tool.role(), Role::Tool(ToolKind::Plugin));
