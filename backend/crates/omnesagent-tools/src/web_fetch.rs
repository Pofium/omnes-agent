...
use omnesagent_config::schema::{FirecrawlConfig, ProxyConfig, ProxyScope};
...
impl WebFetchTool {
    ...
    fn build_redirect_guarded_client(
        ...
        let builder = reqwest::Client::builder()
            ...
            .user_agent("OmnesAgent/0.1 (web_fetch)");
...
mod tests {
    ...
    use omnesagent_config::policy::SecurityPolicy;
    use omnesagent_config::schema::FirecrawlConfig;
    ...
    fn firecrawl_config_defaults() {
        ...
        assert_eq!(cfg.mode, omnesagent_config::schema::FirecrawlMode::Scrape);
    }
    ...
    fn firecrawl_config_deserializes_from_toml() {
        ...
        assert_eq!(cfg.mode, omnesagent_config::schema::FirecrawlMode::Crawl);
    }
    ...
    fn web_fetch_config_with_firecrawl_section() {
        use omnesagent_config::schema::WebFetchConfig;
        let toml_str = r#"
            enabled = true
            [firecrawl]
            enabled = true
