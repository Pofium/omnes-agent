...
use omnesagent_config::schema::{LinkedInContentConfig, LinkedInImageConfig};
...
mod tests {
    ...
    async fn get_content_strategy_returns_config() {
        let content = LinkedInContentConfig {
            ...
            github_repos: vec!["omnesagent-labs/omnesagent".into()],
        ...
        assert!(result.output.contains("omnesagent-labs/omnesagent"));
