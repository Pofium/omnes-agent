...
use omnesagent_config::multi_agent::OutputModality;
use omnesagent_config::multi_agent::PeerGroupConfig;
use omnesagent_config::policy::{SecurityPolicy, ToolOperation};

/// Per-tool channel-map handle — matches `omnesagent_runtime::tools::PerToolChannelHandle`.
...
mod tests {
    ...
    fn invocation_triggers_combine_static_and_live_names() {
        ...
        // Under word-boundary matching (omnesagent_api::tool::
