...
impl Tool for AskUserTool {
    ...
    async fn execute(&self, args: serde_json::Value) -> anyhow::Result<ToolResult> {
        ...
        let listen_handle = omnesagent_spawn::spawn!(async move { listen_channel.listen(tx).await });
...
mod tests {
    ...
    impl ::omnesagent_api::attribution::Attributable for SilentChannel {
    ...
    impl ::omnesagent_api::attribution::Attributable for RespondingChannel {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Channel(
                ::omnesagent_api::attribution::ChannelKind::Webhook,
            )
    ...
    impl ::omnesagent_api::attribution::Attributable for StructuredOnlyChannel {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Channel(
