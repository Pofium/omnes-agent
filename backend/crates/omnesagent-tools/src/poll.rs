...
mod tests {
    ...
    impl ::omnesagent_api::attribution::Attributable for ElicitationCapableChannel {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Channel(
                ::omnesagent_api::attribution::ChannelKind::Webhook,
            )
    ...
    impl ::omnesagent_api::attribution::Attributable for FallbackOnlyChannel {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Channel(
                ::omnesagent_api::attribution::ChannelKind::Webhook,
            )
    ...
    impl ::omnesagent_api::attribution::Attributable for StructuredOnlyNoDeliveryChannel {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Channel(
                ::omnesagent_api::attribution::ChannelKind::Webhook,
            )
