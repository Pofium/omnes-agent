        ...
        let resolved_routes: HashMap<String, (usize, String)> = routes
            ...
            .filter_map(|(hint, route)| {
                ...
                match index {
                    ...
                    None => {
                        ::omnesagent_log::record!(WARN, ::omnesagent_log::Event::new(module_path!(), ::omnesagent_log::Action::Note).with_outcome(::omnesagent_log::EventOutcome::Unknown).with_attrs(::serde_json::json!({"hint": hint, "model_provider": route.provider_name})), "Route references unknown model_provider, skipping");
                        None
                    }
                }
            })
...
impl ModelProvider for RouterModelProvider {
    ...
    async fn chat_with_system(
        ...
        ::omnesagent_log::record!(INFO, ::omnesagent_log::Event::new(module_path!(), ::omnesagent_log::Action::Note).with_attrs(::serde_json::json!({"model_provider": provider_name.as_str(), "model": resolved_model.as_str()})), "router dispatching request");
...
impl ::omnesagent_api::attribution::Attributable for RouterModelProvider {
    fn role(&self) -> ::omnesagent_api::attribution::Role {
        ::omnesagent_api::attribution::Role::Provider(
            ::omnesagent_api::attribution::ProviderKind::Model(
                ::omnesagent_api::attribution::ModelProviderKind::Router,
            ),
        )
    }
    fn alias(&self) -> &str {
...
mod tests {
    ...
    // Arc<MockModelProvider> ModelProvider impl provided by blanket impl in omnesagent-types.
    ...
    impl ::omnesagent_api::attribution::Attributable for StreamingMockModelProvider {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Provider(
                ::omnesagent_api::attribution::ProviderKind::Model(
                    ::omnesagent_api::attribution::ModelProviderKind::Custom,
    ...
    // Arc<StreamingMockModelProvider> ModelProvider impl provided by blanket impl in omnesagent-types.
    ...
    impl ::omnesagent_api::attribution::Attributable for ToolEventStreamingMockModelProvider {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Provider(
                ::omnesagent_api::attribution::ProviderKind::Model(
                    ::omnesagent_api::attribution::ModelProviderKind::Custom,
    ...
    // Arc<ToolEventStreamingMockModelProvider> ModelProvider impl provided by blanket impl in omnesagent-types.
    ...
    impl ::omnesagent_api::attribution::Attributable for CapableMockModelProvider {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Provider(
                ::omnesagent_api::attribution::ProviderKind::Model(
                    ::omnesagent_api::attribution::ModelProviderKind::Custom,
    ...
    fn mixed_tool_capability_matches_the_selected_route_and_model() {
        ...
        impl ::omnesagent_api::attribution::Attributable for ModelScopedMixedProvider {
            fn role(&self) -> ::omnesagent_api::attribution::Role {
                ::omnesagent_api::attribution::Role::Provider(
                    ::omnesagent_api::attribution::ProviderKind::Model(
                        ::omnesagent_api::attribution::ModelProviderKind::Custom,
