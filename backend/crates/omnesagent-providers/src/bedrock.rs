...
#[cfg(windows)]
use omnesagent_config::platform::native::windows_std_cmd_shell_command;
...
impl ::omnesagent_api::attribution::Attributable for BedrockModelProvider {
    fn role(&self) -> ::omnesagent_api::attribution::Role {
        ::omnesagent_api::attribution::Role::Provider(
            ::omnesagent_api::attribution::ProviderKind::Model(
                ::omnesagent_api::attribution::ModelProviderKind::Bedrock,
            ),
        )
    }
    fn alias(&self) -> &str {
...
mod tests {
    ...
    async fn chat_fails_without_credentials() {
        ...
        let model_provider = BedrockModelProvider {
            ...
            auth: None,
            max_tokens: omnesagent_api::model_provider::BASELINE_MAX_TOKENS,
            cred_cache: Mutex::new(None),
        };
