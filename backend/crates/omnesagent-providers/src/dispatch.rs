...
fn provider_reference(provider: &dyn ModelProvider) -> String {
    omnesagent_api::attribution::Attributable::alias(provider).to_string()
}
...
impl ProviderDispatch {
    ...
    pub async fn chat(
        ...
        let span = omnesagent_log::attribution_span!(&*self.inner);
    ...
    pub fn stream_chat(
        ...
        let attribution = omnesagent_log::attribution_span!(&*self.inner);
        ...
        let model_scope = omnesagent_log::info_span!(
