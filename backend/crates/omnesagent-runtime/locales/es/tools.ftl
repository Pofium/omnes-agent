...
tool-proxy-config = Gestionar la configuración del proxy de OmnesAgent (scope: environment | omnesagent | services), incluida la aplicación del entorno de tiempo de ejecución y de proceso
