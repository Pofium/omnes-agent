...
const SHARED_TRANSPORT_CALL_SITES: &[&str] = &[
    "crates/omnesagent-gateway/src/api_sop.rs",
    "crates/omnesagent-gateway/src/api_sop_author.rs",
    "crates/omnesagent-gateway/src/ws.rs",
    "crates/omnesagent-runtime/src/rpc/dispatch.rs",
    "crates/omnesagent-runtime/src/tools/sop_approve.rs",
    "crates/omnesagent-channels/src/orchestrator/mod.rs",
];

fn workspace_root() -> PathBuf {
    // CARGO_MANIFEST_DIR = <root>/crates/omnesagent-runtime
