...
use omnesagent_infra::net_guard::{Nat64Prefix, PrivateNetworkAccess, ResolvedDestination};
...
impl SkillHttpTool {
    ...
    async fn validate_target(&self, raw_url: &str) -> anyhow::Result<ValidatedTarget> {
        ...
        let host = omnesagent_infra::net_guard::normalize_host(request_host)
...
impl Tool for SkillHttpTool {
    ...
    async fn execute(&self, args: serde_json::Value) -> anyhow::Result<ToolResult> {
        ...
        let body =
            match omnesagent_tools::helpers::read_response_text(response, Some(MAX_RESPONSE_BYTES))
                .await
            {
...
mod tests {
    ...
    fn skill_http_tool_rejects_private_metadata_mixed_and_nat64_destinations() {
        ...
        use omnesagent_infra::net_guard::parse_nat64_prefixes;
