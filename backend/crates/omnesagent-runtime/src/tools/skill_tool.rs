...
const SESSION_ID_ENV_VAR: &str = "OMNESAGENT_SESSION_ID";
...
pub struct SkillBuiltinTool {
    tool_name: String,
    tool_description: String,
    target_tool: Arc<dyn omnesagent_api::tool::Tool>,
...
mod tests {
    ...
    impl ::omnesagent_api::attribution::Attributable for MockBuiltinTool {
    ...
    fn skill_builtin_tool_is_extension_even_when_target_is_native() {
        ...
        impl ::omnesagent_api::attribution::Attributable for NativeMockBuiltinTool {
            fn role(&self) -> ::omnesagent_api::attribution::Role {
                self.0.role()
            }
    ...
    impl ::omnesagent_api::attribution::Attributable for EchoArgsTool {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Tool(::omnesagent_api::attribution::ToolKind::Plugin)
        }
        fn alias(&self) -> &str {
