...
pub struct SkillManageTool {
    workspace_dir: PathBuf,
    config: omnesagent_config::schema::SkillImprovementConfig,
...
mod tests {
    ...
    fn cfg_no_cooldown() -> omnesagent_config::schema::SkillImprovementConfig {
        omnesagent_config::schema::SkillImprovementConfig {
            enabled: true,
            cooldown_secs: 0,
            ..Default::default()
        }
    ...
    fn cfg_with_cooldown(secs: u64) -> omnesagent_config::schema::SkillImprovementConfig {
        omnesagent_config::schema::SkillImprovementConfig {
            enabled: true,
            cooldown_secs: secs,
            ..Default::default()
    ...
    async fn skill_manage_patch_blocked_when_improvement_disabled() {
        ...
        let dir = tempdir();
        write_skill(dir.path(), "deploy", VALID_SKILL).await;
        let cfg = omnesagent_config::schema::SkillImprovementConfig {
            enabled: false,
            cooldown_secs: 0,
            ..Default::default()
        };
