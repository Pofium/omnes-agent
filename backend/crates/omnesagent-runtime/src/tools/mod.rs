...
// Tool types from omnesagent-tools (direct imports, no shims)
pub use omnesagent_tools::ask_user::AskUserTool;
pub use omnesagent_tools::ask_user::ChannelMapHandle;
pub use omnesagent_tools::backup_tool::BackupTool;
pub use omnesagent_tools::browser::{BrowserTool, ComputerUseConfig};
pub use omnesagent_tools::browser_delegate::BrowserDelegateTool;
pub use omnesagent_tools::browser_open::BrowserOpenTool;
pub use omnesagent_tools::calculator::CalculatorTool;
pub use omnesagent_tools::canvas::{ALLOWED_CONTENT_TYPES, MAX_CONTENT_SIZE};
pub use omnesagent_tools::canvas::{CanvasStore, CanvasTool};
pub use omnesagent_tools::channel_room::ChannelRoomTool;
pub use omnesagent_tools::claude_code::ClaudeCodeTool;
pub use omnesagent_tools::claude_code_runner::ClaudeCodeRunnerTool;
pub use omnesagent_tools::cli_discovery::{DiscoveredCli, discover_cli_tools};
pub use omnesagent_tools::cloud_ops::CloudOpsTool;
pub use omnesagent_tools::cloud_patterns::CloudPatternsTool;
pub use omnesagent_tools::codex_cli::CodexCliTool;
pub use omnesagent_tools::composio::ComposioTool;
pub use omnesagent_tools::content_search::ContentSearchTool;
pub use omnesagent_tools::data_management::DataManagementTool;
pub use omnesagent_tools::discord_search::DiscordSearchTool;
pub use omnesagent_tools::email_read::EmailReadTool;
pub use omnesagent_tools::email_search::EmailSearchTool;
pub use omnesagent_tools::escalate::EscalateToHumanTool;
pub use omnesagent_tools::file_download::FileDownloadTool;
pub use omnesagent_tools::file_edit::FileEditTool;
pub use omnesagent_tools::file_upload::FileUploadTool;
pub use omnesagent_tools::file_upload_bundle::FileUploadBundleTool;
pub use omnesagent_tools::file_write::FileWriteTool;
pub use omnesagent_tools::gemini_cli::GeminiCliTool;
pub use omnesagent_tools::git_forge::GitForgeTool;
pub use omnesagent_tools::git_operations::GitOperationsTool;
pub use omnesagent_tools::glob_search::GlobSearchTool;
pub use omnesagent_tools::google_workspace::GoogleWorkspaceTool;
pub use omnesagent_tools::hardware_board_info::HardwareBoardInfoTool;
pub use omnesagent_tools::hardware_memory_map::HardwareMemoryMapTool;
pub use omnesagent_tools::hardware_memory_read::HardwareMemoryReadTool;
pub use omnesagent_tools::http_request::HttpRequestTool;
pub use omnesagent_tools::image_gen::ImageGenTool;
pub use omnesagent_tools::image_info::ImageInfoTool;
pub use omnesagent_tools::jira_tool::JiraTool;
pub use omnesagent_tools::knowledge_tool::KnowledgeTool;
pub use omnesagent_tools::linkedin::LinkedInTool;
pub use omnesagent_tools::llm_task::LlmTaskTool;
pub use omnesagent_tools::mcp_client::{McpRegistry, McpServer};
pub use omnesagent_tools::mcp_context;
pub use omnesagent_tools::mcp_deferred::{
...
pub use omnesagent_tools::mcp_prompts_tool::McpPromptsTool;
...
pub use omnesagent_tools::microsoft365::Microsoft365Tool;
pub use omnesagent_tools::model_routing_config::ModelRoutingConfigTool;
pub use omnesagent_tools::notion_tool::NotionTool;
pub use omnesagent_tools::opencode_cli::OpenCodeCliTool;
pub use omnesagent_tools::pipeline::PipelineTool;
pub use omnesagent_tools::poll::PollTool;
pub use omnesagent_tools::project_intel::ProjectIntelTool;
pub use omnesagent_tools::proxy_config::ProxyConfigTool;
pub use omnesagent_tools::pushover::PushoverTool;
pub use omnesagent_tools::reaction::ReactionTool;
pub use omnesagent_tools::report_template_tool::ReportTemplateTool;
pub use omnesagent_tools::screenshot::ScreenshotTool;
pub use omnesagent_tools::send_via::{
    AgentPeerGroupResolver, SendViaTool, TURN_ROUTING, TurnRoutingHandle,
};
pub use omnesagent_tools::sessions::{
    SessionDeleteTool, SessionResetTool, SessionsCurrentTool, SessionsHistoryTool,
    SessionsListTool, SessionsSendTool,
};
pub use omnesagent_tools::text_browser::TextBrowserTool;
pub use omnesagent_tools::tool_search::ToolSearchTool;
pub use omnesagent_tools::weather_tool::WeatherTool;
pub use omnesagent_tools::web_fetch::WebFetchTool;
pub use omnesagent_tools::web_search_tool::WebSearchTool;
pub use omnesagent_tools::wrappers::{PathGuardedTool, RateLimitedTool};

// Traits from omnesagent-api
pub use omnesagent_api::schema::{CleaningStrategy, SchemaCleanr};
pub use omnesagent_api::tool::{Tool, ToolOutput, ToolResult, ToolSpec};
...
use omnesagent_config::schema::{AliasedAgentConfig, Config};
use omnesagent_memory::Memory;

pub type PerToolChannelHandle =
    Arc<RwLock<HashMap<String, Arc<dyn omnesagent_api::channel::Channel>>>>;
...
impl Tool for ArcToolRef {
    ...
    fn param_domains(&self) -> Vec<(&'static str, ::omnesagent_api::tool::OptionDomain)> {
    ...
    fn spec(&self) -> omnesagent_api::tool::ToolSpec {
        self.0.spec()
    }
...
impl ::omnesagent_api::attribution::Attributable for ArcDelegatingTool {
    ...
    fn tool_provenance(&self) -> ::omnesagent_api::attribution::ToolProvenance {
...
pub fn register_skill_tools_with_context_and_runtime(
    ...
    unfiltered_registry: &[Arc<dyn Tool>],
    runtime: Arc<dyn RuntimeAdapter>,
    nat64_prefixes: &[omnesagent_infra::net_guard::Nat64Prefix],
) {
    register_skill_tools_with_context_and_runtime_optional_nat64(
        tools_registry,
        skills,
...
pub(crate) fn register_skill_tools_with_context_and_runtime_optional_nat64(
    ...
    unfiltered_registry: &[Arc<dyn Tool>],
    runtime: Arc<dyn RuntimeAdapter>,
    nat64_prefixes: Option<&[omnesagent_infra::net_guard::Nat64Prefix]>,
) {
    if skills.is_empty() {
        return;
    }
...
pub async fn collect_mcp_elevation_arcs(
    ...
    security: &Arc<omnesagent_config::policy::SecurityPolicy>,
) -> Vec<Arc<dyn Tool>> {
...
impl AllToolsResult {
    ...
    /// harness, bounded delegation, and the `omnesagent-eval` replay harness) and
    ...
    /// out-of-crate `omnesagent-eval` harness can reach it.
...
pub fn all_tools(
    ...
    browser_config: &omnesagent_config::schema::BrowserConfig,
    http_config: &omnesagent_config::schema::HttpRequestConfig,
    web_fetch_config: &omnesagent_config::schema::WebFetchConfig,
    workspace_dir: &std::path::Path,
    agents: &HashMap<String, AliasedAgentConfig>,
    fallback_api_key: Option<&str>,
    root_config: &omnesagent_config::schema::Config,
...
fn filter_agent_peer_groups(
    config: &Config,
    agent_alias: &str,
) -> HashMap<String, omnesagent_config::multi_agent::PeerGroupConfig> {
    config
        .peer_groups
        .iter()
...
/// differently.
///
/// [key]: omnesagent_plugins::instance::PluginInstanceScope::config_entry_key
#[cfg(feature = "plugins-wasm")]
fn plugin_egress_policy(
    config: &Config,
    instance_key: &str,
) -> Result<omnesagent_plugins::egress::EgressPolicy, omnesagent_plugins::egress::EgressError> {
    let (hosts, allow_private) = config.plugins.entry_egress(instance_key);
    omnesagent_plugins::egress::EgressPolicy::new(
        &hosts,
        &allow_private,
...
/// `omnesagent_plugins::egress`'s process-wide registry, keyed by canonical
...
/// miss the row `omnesagent plugin install` seeds and deny every destination the
/// operator granted.
#[cfg(feature = "plugins-wasm")]
fn plugin_egress_service(
    config: Arc<Config>,
    live_config: Option<Arc<parking_lot::RwLock<Config>>>,
) -> omnesagent_plugins::egress::EgressHostService {
    omnesagent_plugins::egress::EgressHostService::new(
        omnesagent_plugins::egress::EgressPolicyResolver::new(move |scope| {
            let instance_key = scope.id().config_entry_key().map_err(|error| {
                omnesagent_plugins::egress::EgressError::PolicyUnavailable(error.to_string())
            })?;
...
fn plugin_config_values(
    ...
    instance_key: &str,
    package: &str,
) -> Result<Option<HashMap<String, String>>, omnesagent_plugins::error::PluginError> {
    config
        .plugins
        .entry_config(instance_key)
        .map(|configured| configured.cloned())
        .map_err(|_| {
            omnesagent_plugins::error::PluginError::InvalidConfig(format!(
...
pub(crate) fn plugin_host_services(
    host: Arc<omnesagent_plugins::host::PluginHost>,
    config: Arc<Config>,
    live_config: Option<Arc<parking_lot::RwLock<Config>>>,
) -> omnesagent_plugins::services::PluginHostServices {
    ...
    let config = omnesagent_plugins::config::PluginConfigResolver::new(move |scope| {
        let package = scope.id().package();
        let config_entry_key = scope.id().config_entry_key()?;
        let manifest = host
            .manifest(package)
            .ok_or_else(|| omnesagent_plugins::error::PluginError::NotFound(package.to_string()))?;
        if let Some(live_config) = &live_config {
            omnesagent_plugins::config::resolve_plugin_config_from(manifest, scope, || {
            ...
            let config = fallback_config.as_ref().ok_or_else(|| {
                omnesagent_plugins::error::PluginError::InvalidConfig(
    ...
    omnesagent_plugins::services::PluginHostServices::new(config)
}
...
pub fn all_tools_with_runtime(
    ...
    live_config: Option<Arc<parking_lot::RwLock<omnesagent_config::schema::Config>>>,
) -> AllToolsResult {
    ...
    let coding_cli_executor = coding_cli_executor::RuntimeCodingCliExecutor::shared(
        runtime.clone(),
        sandbox.clone(),
        root_config.runtime.kind == omnesagent_config::schema::RuntimeKind::Native,
    );
    ...
    if root_config.channels.discord.values().any(|d| d.archive) {
        match omnesagent_memory::SqliteMemory::new_named("sqlite", &config.data_dir, "discord") {
            Ok(discord_mem) => {
    ...
    // email_search — registered when at least one email channel is enabled
    {
        let email_configs: std::collections::HashMap<
            String,
            omnesagent_config::scattered_types::EmailConfig,
        > = root_config
            .channels
            .email
            .iter()
        ...
        if !email_configs.is_empty() {
            let auth_service = if email_configs.values().any(|c| c.oauth2.is_some()) {
                Some(Arc::new(
                    omnesagent_providers::auth::AuthService::from_config(root_config),
                ))
            } else {
                None
            };
    ...
    if let Some((family, alias, entry)) = root_config.resolved_model_provider_for_agent(agent_alias)
    {
        ...
        let llm_task_runtime_options =
            omnesagent_providers::provider_runtime_options_for_alias(root_config, family, alias);
    ...
    if let Ok(backend) =
        omnesagent_infra::make_session_backend(&config.data_dir, &config.channels.session_backend)
    {
    ...
    if root_config.microsoft365.enabled {
        ...
        if !tenant_id.is_empty() && !client_id.is_empty() {
            ...
            let resolved = omnesagent_tools::microsoft365::types::Microsoft365ResolvedConfig {
                tenant_id,
                client_id,
    ...
    if root_config.knowledge.enabled {
        ...
        match omnesagent_memory::knowledge_graph::KnowledgeGraph::new(
            &db_path,
    ...
    let provider_runtime_options =
        omnesagent_providers::provider_runtime_options_for_agent(root_config, agent_alias);
    ...
    let delegate_handle: Option<DelegateParentToolsHandle> = if agents.is_empty() {
        ...
        .with_providers_models({
            let mut m: std::collections::HashMap<
                String,
                std::collections::HashMap<String, omnesagent_config::schema::ModelProviderConfig>,
    ...
    #[cfg(feature = "plugins-wasm")]
    {
        ...
        if plugin_path.exists() && config.plugins.enabled {
            let signature_mode = omnesagent_plugins::host::PluginHost::resolve_signature_mode(
                &config.plugins.security.signature_mode,
            );
            let trusted_publisher_keys = config.plugins.security.trusted_publisher_keys.clone();
            match omnesagent_plugins::host::PluginHost::from_plugins_dir_with_security(
                &plugin_path,
                signature_mode,
                ...
                Ok(host) => {
                    ...
                    let plugin_limits = omnesagent_plugins::component::PluginLimits {
        ...
        if config.plugins.enabled {
            for legacy in omnesagent_config::schema::legacy_plugin_dirs_with_entries(&config) {
                ::omnesagent_log::record!(
                    WARN,
                    ::omnesagent_log::Event::new(module_path!(), ::omnesagent_log::Action::Note)
                        .with_outcome(::omnesagent_log::EventOutcome::Unknown)
                    ...
                    "Plugins in a legacy directory are not loaded; run `omnesagent plugin migrate`"
                );
            }
        }
    }
...
fn register_plugin_tools(
    config: &Config,
    host: &omnesagent_plugins::host::PluginHost,
    services: &omnesagent_plugins::services::PluginHostServices,
    plugin_limits: omnesagent_plugins::component::PluginLimits,
    egress: Option<omnesagent_plugins::egress::EgressHostService>,
    registered_names: &mut std::collections::HashSet<String>,
    ...
    let admitted: Vec<_> = plan
        .scopes(omnesagent_plugins::PluginCapability::Tool)
        .collect();
    ...
    for scope in admitted {
        ...
        let tool = omnesagent_plugins::wasm_tool::WasmTool::from_wasm(
...
mod tests {
    ...
    async fn mcp_capability_tools_respect_policy() {
        use omnesagent_tools::tool_search::ToolAccessPolicy;
...
"#,
        ...
        .unwrap();
        let host = Arc::new(
            omnesagent_plugins::host::PluginHost::from_plugins_dir(plugins_dir.path()).unwrap(),
        );
        let manifest = host.manifest("fixture-plugin").unwrap();
        let scope = omnesagent_plugins::instance::PluginInstanceScope::from_manifest(
            manifest,
            omnesagent_plugins::PluginCapability::Tool,
            "work",
            [omnesagent_plugins::PluginPermission::ConfigRead],
        )
        .unwrap();
        let backup_scope = omnesagent_plugins::instance::PluginInstanceScope::from_manifest(
            manifest,
            omnesagent_plugins::PluginCapability::Tool,
            "backup",
            [omnesagent_plugins::PluginPermission::ConfigRead],
        ...
        let entry = |name: &str, enabled: &str| omnesagent_config::schema::PluginEntryConfig {
            name: name.to_string(),
    ...
    /// grant authored on the instance-key row that `omnesagent plugin install`
...
"#,
        ...
        let scope = omnesagent_plugins::instance::PluginInstanceScope::for_package_binding(
            manifest,
            omnesagent_plugins::PluginCapability::Tool,
        ...
        let entry = |name: &str| omnesagent_config::schema::PluginEntryConfig {
            name: name.to_string(),
            config: HashMap::new(),
        ...
        let request = || {
            omnesagent_plugins::egress::EgressRequest::new(
                scope.clone(),
                omnesagent_plugins::egress::EgressTransport::Http { encrypted: true },
                "api.example.com",
                443,
            )
            .unwrap()
        ...
        assert!(
            matches!(
                ...
                Err(omnesagent_plugins::egress::EgressError::DestinationNotGranted { .. })
            ),
    ...
    #[cfg(feature = "plugins-wasm")]
    fn test_plugin_limits() -> omnesagent_plugins::component::PluginLimits {
        omnesagent_plugins::component::PluginLimits {
            call_fuel: 1_000_000,
    ...
    fn recording_resolver(
        ...
        omnesagent_plugins::config::PluginConfigResolver,
        ...
        let resolver = {
            ...
            omnesagent_plugins::config::PluginConfigResolver::new(move |scope| {
                let package = scope.id().package().to_string();
                probed.lock().unwrap().push(package.clone());
                let manifest = host.manifest(&package).ok_or_else(|| {
                    omnesagent_plugins::error::PluginError::NotFound(package.clone())
                })?;
                omnesagent_plugins::config::resolve_plugin_config(manifest, scope, None)
            })
        };
        (resolver, probed)
    }
    ...
    fn tool_packages_reaching_construction(
        ...
        let services = omnesagent_plugins::services::PluginHostServices::new(resolver);
    ...
    fn colliding_plugin_is_refused_before_its_guest_is_constructed() {
        ...
        let host =
            Arc::new(omnesagent_plugins::host::PluginHost::from_plugins_dir(plugins.path()).unwrap());
    ...
    fn mixed_capability_fixture(plugins: &TempDir) -> Config {
        ...
        config.channels.plugin = HashMap::from([(
            "ops".to_string(),
            omnesagent_config::schema::PluginChannelConfig {
        ...
        config.agents = HashMap::from([(
            "operator".to_string(),
            AliasedAgentConfig {
                channels: vec![omnesagent_config::providers::ChannelRef::new("plugin.ops")],
    ...
    fn component_with_failed_metadata_probe_is_not_registered() {
        ...
        let tools = all_tools(
            ...
            None,
            &browser,
            &omnesagent_config::schema::HttpRequestConfig::default(),
            &omnesagent_config::schema::WebFetchConfig::default(),
            tmp.path(),
            &HashMap::new(),
            None,
            &config,
    ...
    async fn web_search_tool_is_registered_behind_the_rate_limiter() {
        ...
        let http = omnesagent_config::schema::HttpRequestConfig::default();
    ...
    async fn docker_without_workspace_mount_does_not_register_coding_cli_tools() {
        ...
        let tools = all_tools_with_runtime(
            ...
            &risk,
            "test-agent",
            Arc::new(omnesagent_config::platform::DockerRuntime::new(
    ...
    fn shared_sop_engine_arc_is_observed_by_multiple_registrations() {
        ...
        let http = omnesagent_config::schema::HttpRequestConfig::default();
        let web = omnesagent_config::schema::WebFetchConfig::default();
    ...
    async fn sop_approve_registry_binds_the_calling_agent_alias() {
        ...
        groups.insert(
            "release".to_string(),
            ApprovalGroupConfig {
                members: vec!["agent:OmnesAgentOperator".to_string()],
            },
        );
        ...
        let mut engine = SopEngine::new(omnesagent_config::schema::SopConfig {
        ...
        let unauthorized_tools = build("OmnesAgentAgent", mem.clone());
        let authorized_tools = build("OmnesAgentOperator", mem);
    ...
    fn shared_store_tools_open_data_dir_not_per_agent_workspace() {
        ...
        root_config.channels.discord.insert(
            "oracle".to_string(),
            omnesagent_config::schema::DiscordConfig {
                archive: true,
                ..Default::default()
            },
        );
    ...
    async fn sop_audit_memory_uses_agent_alias_not_default() {
        ...
        let config = Config {
            data_dir: tmp.path().join("data"),
            config_path: tmp.path().join("config.toml"),
            sop: omnesagent_config::schema::SopConfig {
        ...
        let mem = omnesagent_memory::create_memory_for_agent(&config, "ops", None).await;
        assert!(
            mem.is_ok(),
        ...
        let mem_default = omnesagent_memory::create_memory_for_agent(&config, "default", None).await;
        assert!(
            mem_default.is_err(),
    ...
    fn all_tools_excludes_read_skill_for_explicit_global_full() {
        ...
        let http = omnesagent_config::schema::HttpRequestConfig::default();
        let mut cfg = test_config(&tmp);
        cfg.skills.prompt_injection_mode = omnesagent_config::schema::SkillsPromptInjectionMode::Full;
...
mod wrapper_spec_forwarding_tests {
    ...
    impl ::omnesagent_api::attribution::Attributable for ArcSchemaTool {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Tool(::omnesagent_api::attribution::ToolKind::Plugin)
        }
        fn alias(&self) -> &str {
            "arc-schema-tool"
        }
