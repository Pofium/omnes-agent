...
use omnesagent_tools::embedded_resource::{content_hash_name, materialize_bytes};
...
/// [`omnesagent_api::agent::ToolArtifact`]), not a second formatter.
...
/// [`omnesagent_api::agent::ToolArtifact`]) without embedding file bytes in the
