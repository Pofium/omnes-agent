...
use omnesagent_tools::coding_cli::{
...
mod tests {
    ...
    use {
        ...
        std::sync::Mutex, omnesagent_api::runtime_traits::RuntimeAdapter, omnesagent_api::tool::Tool,
        omnesagent_config::autonomy::AutonomyLevel, omnesagent_config::schema::CodexCliConfig,
        omnesagent_tools::codex_cli::CodexCliTool,
    };
    ...
    impl RuntimeAdapter for FakeRuntime {
        ...
        fn shell_dialect(&self) -> omnesagent_api::runtime_traits::ShellDialect {
            omnesagent_api::runtime_traits::ShellDialect::Posix
        }
