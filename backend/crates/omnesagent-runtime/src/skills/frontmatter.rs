...
use omnesagent_config::traits::{PropFieldInfo, PropKind};
    ...
    pub fn prop_fields() -> Vec<PropFieldInfo> {
        vec![
            ...
            PropFieldInfo {
                ...
                is_secret: false,
                enum_variants: None,
                description: "Free-form tags. The `slash` tag opts the skill into Discord slash commands (omnesagent-labs/omnesagent#7490); others drive tiering / registry grouping.",
                derived_from_secret: false,
                credential_class: None,
                tab: omnesagent_config::config::ConfigTab::None,
                alias_source: None,
                multiline: false,
            },
            PropFieldInfo {
