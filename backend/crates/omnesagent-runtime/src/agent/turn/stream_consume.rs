...
use omnesagent_providers::{ChatMessage, ChatRequest, ModelProvider, ProviderDispatch, ToolCall};
...
pub(crate) struct StreamedChatOutcome {
    ...
    pub(crate) usage: Option<omnesagent_providers::traits::TokenUsage>,
...
pub(crate) async fn consume_provider_streaming_response(
    ...
    let mut provider_stream = ProviderDispatch::from_ref(model_provider).stream_chat(
        ...
        model,
        temperature,
        omnesagent_providers::traits::StreamOptions::new(true),
    );
            ...
            Err(err) => {
                ...
                if visible_event_output {
                    ...
                    return Err(StreamInterruptedAfterOutput {
                        ...
                        message,
                        usage: outcome.usage,
                        cause: omnesagent_providers::ReliableProviderTerminalFailure::from_error(
                            &provider_error,
                        ),
                    }
                    .into());
...
mod tests {
    ...
    use omnesagent_api::model_provider::StreamChunk;
    use omnesagent_providers::ToolCall;
    use omnesagent_providers::traits::{
    ...
    impl ::omnesagent_api::attribution::Attributable for ToolThenTextProvider {
    ...
    impl ::omnesagent_api::attribution::Attributable for EmptyStreamProvider {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Provider(
                ::omnesagent_api::attribution::ProviderKind::Model(
                    ::omnesagent_api::attribution::ModelProviderKind::Custom,
    ...
    impl ::omnesagent_api::attribution::Attributable for ReasoningProvider {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Provider(
                ::omnesagent_api::attribution::ProviderKind::Model(
                    ::omnesagent_api::attribution::ModelProviderKind::Custom,
    ...
    impl ::omnesagent_api::attribution::Attributable for CancelAfterUsageProvider {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Provider(
                ::omnesagent_api::attribution::ProviderKind::Model(
                    ::omnesagent_api::attribution::ModelProviderKind::Custom,
    ...
    impl ::omnesagent_api::attribution::Attributable for ThinkingSplitProvider {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Provider(
                ::omnesagent_api::attribution::ProviderKind::Model(
                    ::omnesagent_api::attribution::ModelProviderKind::Custom,
    ...
    async fn cancellation_after_visible_output_preserves_usage_and_partial_text() {
        ...
        let observed_chunk = omnesagent_spawn::spawn!(async move {
    ...
    impl ::omnesagent_api::attribution::Attributable for MarkerTestProvider {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Provider(
                ::omnesagent_api::attribution::ProviderKind::Model(
                    ::omnesagent_api::attribution::ModelProviderKind::Custom,
    ...
    impl ::omnesagent_api::attribution::Attributable for MarkerOnlyThenErrorProvider {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Provider(
                ::omnesagent_api::attribution::ProviderKind::Model(
                    ::omnesagent_api::attribution::ModelProviderKind::Custom,
    ...
    impl ModelProvider for MarkerOnlyThenErrorProvider {
        ...
        fn stream_chat(
            ...
            let events: Vec<StreamResult<StreamEvent>> = vec![
                ...
                Err(::omnesagent_api::model_provider::StreamError::ModelProvider(
    ...
    impl ::omnesagent_api::attribution::Attributable for LiveMarkerTimingProvider {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Provider(
                ::omnesagent_api::attribution::ProviderKind::Model(
                    ::omnesagent_api::attribution::ModelProviderKind::Custom,
