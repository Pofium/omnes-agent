...
mod tests {
    ...
    use std::sync::{Arc, Mutex};
    use omnesagent_api::attribution::Role;
    use omnesagent_api::model_provider::{ModelProvider, ProviderCapabilities};
    ...
    impl omnesagent_api::attribution::Attributable for NativeToolsProvider {
        fn role(&self) -> Role {
            Role::System
        }
    ...
    impl omnesagent_api::attribution::Attributable for PromptToolsProvider {
        fn role(&self) -> Role {
            Role::System
        }
    ...
    impl omnesagent_api::attribution::Attributable for CountingTool {
        fn role(&self) -> Role {
            Role::Tool(omnesagent_api::attribution::ToolKind::Plugin)
        }
