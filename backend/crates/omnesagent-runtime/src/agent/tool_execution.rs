...
use omnesagent_api::agent::{ToolArtifact, TurnEvent};
...
pub(crate) fn resolved_tool_provenance(
    ...
    name: &str,
) -> Option<omnesagent_api::attribution::ToolProvenance> {
...
pub(crate) async fn execute_one_tool(
    ...
    let tool_span = ::omnesagent_log::info_span!(
...
mod tests {
    ...
    impl omnesagent_api::attribution::Attributable for CountingTool {
        fn role(&self) -> omnesagent_api::attribution::Role {
            omnesagent_api::attribution::Role::System
        }
        fn alias(&self) -> &str {
            "test-counting-tool"
        }
    ...
    fn resolved_provenance_uses_activated_mcp_tool() {
        ...
        assert_eq!(
            ...
            Some(omnesagent_api::attribution::ToolProvenance::Extension)
        );
    }
    ...
    /// (`crates/omnesagent-tools/src/http_request.rs:672-680`).
    ...
    #[async_trait]
    impl omnesagent_api::attribution::Attributable for FailingToolWithDetailedOutput {
        fn role(&self) -> omnesagent_api::attribution::Role {
            omnesagent_api::attribution::Role::System
        }
        fn alias(&self) -> &str {
    ...
    impl Tool for FailingToolWithDetailedOutput {
        ...
        async fn execute(
            ...
            Ok(crate::tools::ToolResult {
                success: false,
                output: omnesagent_api::tool::ToolOutput::json_with_text(
    ...
    #[async_trait]
    impl omnesagent_api::attribution::Attributable for FailingToolWithNoOutput {
        fn role(&self) -> omnesagent_api::attribution::Role {
            omnesagent_api::attribution::Role::System
        }
        fn alias(&self) -> &str {
    ...
    impl Tool for FailingToolWithNoOutput {
        ...
        async fn execute(
            ...
            Ok(crate::tools::ToolResult {
                success: false,
                output: omnesagent_api::tool::ToolOutput::default(),
    ...
    async fn execute_one_tool_preserves_http_request_400_body_from_real_producer() {
        ...
        let http_tool = omnesagent_tools::http_request::HttpRequestTool::new(
            Arc::new(omnesagent_config::policy::SecurityPolicy {
                autonomy: AutonomyLevel::Supervised,
                ..omnesagent_config::policy::SecurityPolicy::default()
            }),
            vec!["127.0.0.1".into()],
            1_000_000,
            5,
    ...
    #[async_trait]
    impl omnesagent_api::attribution::Attributable for FailingToolWithPlainTextOutput {
        fn role(&self) -> omnesagent_api::attribution::Role {
            omnesagent_api::attribution::Role::System
        }
        fn alias(&self) -> &str {
    ...
    #[async_trait]
    impl omnesagent_api::attribution::Attributable for FailingToolWithOutputIdenticalToError {
        fn role(&self) -> omnesagent_api::attribution::Role {
            omnesagent_api::attribution::Role::System
        }
        fn alias(&self) -> &str {
    ...
    #[async_trait]
    impl omnesagent_api::attribution::Attributable for FailingToolWithNoErrorField {
        fn role(&self) -> omnesagent_api::attribution::Role {
            omnesagent_api::attribution::Role::System
        }
        fn alias(&self) -> &str {
    ...
    #[async_trait]
    impl omnesagent_api::attribution::Attributable for FailingToolWithSecretInOutput {
        fn role(&self) -> omnesagent_api::attribution::Role {
            omnesagent_api::attribution::Role::System
        }
        fn alias(&self) -> &str {
    ...
    struct ConfigurableFailingTool {
        output: omnesagent_api::tool::ToolOutput,
        error: Option<String>,
    }

    #[async_trait]
    impl omnesagent_api::attribution::Attributable for ConfigurableFailingTool {
        fn role(&self) -> omnesagent_api::attribution::Role {
            omnesagent_api::attribution::Role::System
        }
        fn alias(&self) -> &str {
    ...
    async fn execute_one_tool_scrubs_model_visible_credential_across_failure_shapes() {
        use omnesagent_api::tool::ToolOutput;
    ...
    #[async_trait]
    impl omnesagent_api::attribution::Attributable for FailingToolReturningErr {
        fn role(&self) -> omnesagent_api::attribution::Role {
            omnesagent_api::attribution::Role::System
        }
        fn alias(&self) -> &str {
    ...
    async fn failure_output_scrub_leaves_bearer_prefixed_token_but_still_runs() {
        let tools: Vec<Box<dyn Tool>> = vec![Box::new(ConfigurableFailingTool {
            output: omnesagent_api::tool::ToolOutput::text(
    ...
    async fn failed_tool_credential_is_scrubbed_in_provider_history() {
        ...
        let tools: Vec<Box<dyn Tool>> = vec![Box::new(ConfigurableFailingTool {
            output: omnesagent_api::tool::ToolOutput::text(format!(
        ...
        let native_calls: Vec<omnesagent_providers::ToolCall> = Vec::new();
    ...
    use crate::approval::ApprovalManager;
    use omnesagent_config::autonomy::AutonomyLevel;
    use omnesagent_config::schema::RiskProfileConfig;
