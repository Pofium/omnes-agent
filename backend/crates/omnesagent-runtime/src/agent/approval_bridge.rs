...
impl ::omnesagent_api::attribution::Attributable for AskUserApprovalBridge {
...
mod tests {
    ...
    impl ::omnesagent_api::attribution::Attributable for RecipientScopedApprover {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Channel(
                ::omnesagent_api::attribution::ChannelKind::Cli,
            )
        }
        fn alias(&self) -> &str {
            &self.name
    ...
    impl ::omnesagent_api::attribution::Attributable for TimedOutApprover {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Channel(
                ::omnesagent_api::attribution::ChannelKind::Cli,
            )
