...
//!
//! The component is the in-tree `omnesagent-plugins` tool fixture, built on demand
...
use omnesagent_plugins::{PluginCapability, PluginManifest};
    ...
    FIXTURE
        .get_or_init(|| {
            let fixture_dir = PathBuf::from(env!("CARGO_MANIFEST_DIR"))
                .join("../omnesagent-plugins/tests/fixtures/tool-fixture");
...
/// Lay out a plugins dir the way `omnesagent plugin install` does, and return the
