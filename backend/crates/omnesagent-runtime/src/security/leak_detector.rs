...
use omnesagent_config::schema::LeakDetectionConfig;
...
"#;
    ...
    fn generated_workspace_paths_not_redacted_as_high_entropy() {
        ...
        let cases = [
            ...
            "/home/omnesagent/.omnesagent/agents/scribe/workspace/tasks/inbox/2026-07-02-13-20-plan-b-draft-materialization.md",
            "/home/omnesagent/.omnesagent/agents/scribe/workspace/drafts/2026-07-02-plan-b-for-something-useful/",
    ...
    fn media_markers_not_redacted_as_high_entropy() {
        let detector = LeakDetector::new();
        let content = "Here is the image: [IMAGE:/Users/matt/.omnesagent/workspace/skills/image-gen/images/20260324_135911.png]";
        let result = detector.scan(content);
        assert!(
            matches!(result, LeakResult::Clean),
    ...
    fn media_marker_image_path_not_redacted() {
        let detector = LeakDetector::new();
        let content = "Here is your image: [IMAGE:/Users/matt/.omnesagent/workspace/skills/image-gen/images/20260324_135911.png]";
        let result = detector.scan(content);
        assert!(
            matches!(result, LeakResult::Clean),
