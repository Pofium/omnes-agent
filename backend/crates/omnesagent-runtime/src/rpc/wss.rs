...
/// [`omnesagent_tls::build_mtls_acceptor`].
pub fn build_tls_acceptor(
    ...
    omnesagent_tls::build_mtls_acceptor(cert_path, key_path, ca_cert_path, pinned_certs, crl_path)
}
            ...
            accept = listener.accept() => {
                ...
                omnesagent_spawn::spawn!(async move {
                    ...
                    let peer_cert_fp = ws_stream
                        ...
                        .map(|der| omnesagent_tls::cert_sha256_fingerprint(der.as_ref()));
