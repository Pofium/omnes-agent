...
use omnesagent_api::jsonrpc::{FsEntry, FsListDirRequest, FsListDirResponse};

/// Handle `fs/list_dir`.
pub async fn handle_fs_list_dir(
    params: &serde_json::Value,
) -> Result<serde_json::Value, omnesagent_api::jsonrpc::JsonRpcError> {
...
fn rpc_err(code: i32, msg: impl Into<String>) -> omnesagent_api::jsonrpc::JsonRpcError {
    omnesagent_api::jsonrpc::JsonRpcError {
        code,
        message: msg.into(),
        data: None,
    }
