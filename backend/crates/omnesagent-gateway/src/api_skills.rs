//! HTTP adapter over `omnesagent_runtime::skills::SkillsService`.
...
pub async fn handle_slash_option_kinds(
    ...
    Json(SlashOptionKindsResult {
        kinds: omnesagent_runtime::skills::slash_option_kinds(),
    })
    .into_response()
}
...
pub async fn handle_write_skill(
    ...
    let doc = omnesagent_runtime::skills::SkillDocument {
...
mod tests {
    ...
    use omnesagent_runtime::skills::{ShadowedSkill, SkillOrigin};
