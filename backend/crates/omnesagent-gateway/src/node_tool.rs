//! Wraps a node capability as a omnesagent [`Tool`] so it can be dispatched
...
use omnesagent_tools::node_capabilities::requires_approval;
...
/// A omnesagent [`Tool`] backed by a node capability.
