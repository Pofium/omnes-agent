...
//! request time (`omnesagent_providers::multimodal`).
//!
//! Acceptance is decided by [`omnesagent_api::media::image_mime_from_magic`]
//! filtered through [`omnesagent_api::media::is_provider_image_mime`] — the same
