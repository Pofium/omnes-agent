//! Flash OmnesAgent Arduino firmware via arduino-cli.
...
/// OmnesAgent Arduino Uno base firmware (capabilities, gpio_read, gpio_write).
...
/// Flash OmnesAgent firmware to Arduino at the given port.
pub fn flash_arduino_firmware(port: &str) -> Result<()> {
    ...
    with_flash_temp_dir(&std::env::temp_dir(), |temp_dir| {
        ...
        // Compile
        println!("Compiling OmnesAgent Arduino firmware...");
    ...
    println!("OmnesAgent firmware flashed successfully.");
