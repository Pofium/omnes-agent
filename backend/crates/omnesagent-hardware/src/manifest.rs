//! Plugin manifest — `~/.omnesagent/tools/<name>/tool.toml` schema.
...
/// Execution configuration — how OmnesAgent spawns the tool.
#[derive(Debug, Deserialize)]
...
/// When present, OmnesAgent will prefer the named transport kind
