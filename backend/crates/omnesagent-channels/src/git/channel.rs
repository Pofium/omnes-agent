...
use omnesagent_config::schema::GitConfig;
...
impl ::omnesagent_api::attribution::Attributable for GitChannel {
    fn role(&self) -> ::omnesagent_api::attribution::Role {
        ::omnesagent_api::attribution::Role::Channel(::omnesagent_api::attribution::ChannelKind::Git)
    }
    fn alias(&self) -> &str {
        &self.alias
    }
...
impl Channel for GitChannel {
    ...
    async fn forge_request(
        &self,
        request: omnesagent_api::channel::ForgeApiRequest,
    ) -> anyhow::Result<omnesagent_api::channel::ForgeApiResponse> {
        ...
        let resp = self
            ...
            .await?;
        Ok(omnesagent_api::channel::ForgeApiResponse {
            status: resp.status,
            body: resp.body,
        })
    }
    ...
    mod github_integration {
        ...
        async fn sop_route_emits_sop_event_without_mention_gate() {
            ...
            cfg.events.insert(
                ...
                omnesagent_config::schema::GitEventRoute {
                    message: false,
            ...
            assert_eq!(
                ...
                Some("omnesagent:sop-event:git.main:pull_request.opened")
            );
