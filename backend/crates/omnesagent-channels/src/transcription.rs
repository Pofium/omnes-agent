...
use omnesagent_config::providers::{TranscriptionProviderEntry, TranscriptionProviders};
use omnesagent_config::schema::{Config, TranscriptionConfig};
...
#[async_trait]
pub trait TranscriptionProvider: Send + Sync + ::omnesagent_api::attribution::Attributable {
...
impl GroqProvider {
        ...
        let api_key = config
            ...
            .context(
                "Missing transcription API key: set `[transcription].api_key` (or via the \
                 schema-mirror grammar `OMNESAGENT_transcription__api_key=...`).",
            )?;
    ...
    pub fn from_typed_config(
        alias: &str,
        cfg: &omnesagent_config::schema::GroqTranscriptionProviderConfig,
    ) -> Result<Self> {
        let api_key = cfg
            .base
            .api_key
...
impl TranscriptionProvider for GroqProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client = omnesagent_config::schema::build_runtime_proxy_client("transcription.groq");
...
impl OpenAiWhisperProvider {
    pub fn from_config(
        alias: &str,
        config: &omnesagent_config::schema::OpenAiSttConfig,
    ) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
    ...
    pub fn from_typed_config(
        alias: &str,
        cfg: &omnesagent_config::schema::OpenAiTranscriptionProviderConfig,
    ) -> Result<Self> {
        let api_key = cfg
            .base
            .api_key
...
impl TranscriptionProvider for OpenAiWhisperProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client = omnesagent_config::schema::build_runtime_proxy_client("transcription.openai");
...
impl DeepgramProvider {
    pub fn from_config(
        alias: &str,
        config: &omnesagent_config::schema::DeepgramSttConfig,
    ) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
    ...
    pub fn from_typed_config(
        alias: &str,
        cfg: &omnesagent_config::schema::DeepgramTranscriptionProviderConfig,
    ) -> Result<Self> {
        let api_key = cfg
            .base
            .api_key
...
impl TranscriptionProvider for DeepgramProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client = omnesagent_config::schema::build_runtime_proxy_client("transcription.deepgram");
...
impl AssemblyAiProvider {
    pub fn from_config(
        alias: &str,
        config: &omnesagent_config::schema::AssemblyAiSttConfig,
    ) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
    ...
    pub fn from_typed_config(
        alias: &str,
        cfg: &omnesagent_config::schema::AssemblyAiTranscriptionProviderConfig,
    ) -> Result<Self> {
        let api_key = cfg
            .base
            .api_key
...
impl TranscriptionProvider for AssemblyAiProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client =
            omnesagent_config::schema::build_runtime_proxy_client("transcription.assemblyai");
...
impl GoogleSttProvider {
    pub fn from_config(
        alias: &str,
        config: &omnesagent_config::schema::GoogleSttConfig,
    ) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
    ...
    pub fn from_typed_config(
        alias: &str,
        cfg: &omnesagent_config::schema::GoogleTranscriptionProviderConfig,
    ) -> Result<Self> {
        let api_key = cfg
            .base
            .api_key
    ...
    fn build_request(&self, request_body: &serde_json::Value) -> Result<reqwest::RequestBuilder> {
        Ok(
            omnesagent_config::schema::build_runtime_proxy_client("transcription.google")
...
impl LocalWhisperProvider {
    ...
    pub fn from_config(
        alias: &str,
        config: &omnesagent_config::schema::LocalWhisperConfig,
    ) -> Result<Self> {
    ...
    pub fn from_typed_config(
        alias: &str,
        cfg: &omnesagent_config::schema::LocalWhisperTranscriptionProviderConfig,
    ) -> Result<Self> {
        let bridge = omnesagent_config::schema::LocalWhisperConfig {
            url: cfg.uri.clone(),
...
impl TranscriptionProvider for LocalWhisperProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client =
            omnesagent_config::schema::build_runtime_proxy_client("transcription.local_whisper");
...
impl TranscriptionManager {
    ...
    pub async fn transcribe_with_provider(
        ...
        let span = ::omnesagent_log::attribution_span!(p.as_ref());
...
impl ::omnesagent_api::attribution::Attributable for GroqProvider {
    fn role(&self) -> ::omnesagent_api::attribution::Role {
        ::omnesagent_api::attribution::Role::Provider(
            ::omnesagent_api::attribution::ProviderKind::Transcription(
                ::omnesagent_api::attribution::TranscriptionProviderKind::Groq,
            ),
        )
    }
    fn alias(&self) -> &str {
...
impl ::omnesagent_api::attribution::Attributable for OpenAiWhisperProvider {
    fn role(&self) -> ::omnesagent_api::attribution::Role {
        ::omnesagent_api::attribution::Role::Provider(
            ::omnesagent_api::attribution::ProviderKind::Transcription(
                ::omnesagent_api::attribution::TranscriptionProviderKind::OpenAi,
            ),
        )
    }
    fn alias(&self) -> &str {
...
impl ::omnesagent_api::attribution::Attributable for DeepgramProvider {
    fn role(&self) -> ::omnesagent_api::attribution::Role {
        ::omnesagent_api::attribution::Role::Provider(
            ::omnesagent_api::attribution::ProviderKind::Transcription(
                ::omnesagent_api::attribution::TranscriptionProviderKind::Deepgram,
            ),
        )
    }
    fn alias(&self) -> &str {
...
impl ::omnesagent_api::attribution::Attributable for AssemblyAiProvider {
    fn role(&self) -> ::omnesagent_api::attribution::Role {
        ::omnesagent_api::attribution::Role::Provider(
            ::omnesagent_api::attribution::ProviderKind::Transcription(
                ::omnesagent_api::attribution::TranscriptionProviderKind::AssemblyAi,
            ),
        )
    }
    fn alias(&self) -> &str {
...
impl ::omnesagent_api::attribution::Attributable for GoogleSttProvider {
    fn role(&self) -> ::omnesagent_api::attribution::Role {
        ::omnesagent_api::attribution::Role::Provider(
            ::omnesagent_api::attribution::ProviderKind::Transcription(
                ::omnesagent_api::attribution::TranscriptionProviderKind::Google,
            ),
        )
    }
    fn alias(&self) -> &str {
...
impl ::omnesagent_api::attribution::Attributable for LocalWhisperProvider {
    fn role(&self) -> ::omnesagent_api::attribution::Role {
        ::omnesagent_api::attribution::Role::Provider(
            ::omnesagent_api::attribution::ProviderKind::Transcription(
                ::omnesagent_api::attribution::TranscriptionProviderKind::Whisper,
            ),
        )
    }
    fn alias(&self) -> &str {
...
mod tests {
    ...
    impl ::omnesagent_api::attribution::Attributable for StaticTranscriptionProvider {
        fn role(&self) -> ::omnesagent_api::attribution::Role {
            ::omnesagent_api::attribution::Role::Provider(
                ::omnesagent_api::attribution::ProviderKind::Transcription(
                    ::omnesagent_api::attribution::TranscriptionProviderKind::Groq,
    ...
    fn manager_registers_multiple_providers() {
        ...
        let config = TranscriptionConfig {
            api_key: Some("test-groq-key".to_string()),
            openai: Some(omnesagent_config::schema::OpenAiSttConfig {
                api_key: Some("test-openai-key".to_string()),
                model: "whisper-1".to_string(),
            }),
            deepgram: Some(omnesagent_config::schema::DeepgramSttConfig {
        ...
        config.providers.transcription.groq.insert(
            ...
            omnesagent_config::schema::GroqTranscriptionProviderConfig {
                base: omnesagent_config::schema::TranscriptionProviderConfig {
                    api_key: Some("test-groq-key".to_string()),
                    ..omnesagent_config::schema::TranscriptionProviderConfig::default()
                },
                ..omnesagent_config::schema::GroqTranscriptionProviderConfig::default()
            },
        );
    ...
    fn typed_registration_logs_all_family_errors_across_entry_points() {
        ...
        typed.openai.insert(
            "invalid".to_string(),
            omnesagent_config::schema::OpenAiTranscriptionProviderConfig::default(),
        );
        typed.deepgram.insert(
            "invalid".to_string(),
            omnesagent_config::schema::DeepgramTranscriptionProviderConfig::default(),
        );
        typed.assemblyai.insert(
            "invalid".to_string(),
            omnesagent_config::schema::AssemblyAiTranscriptionProviderConfig::default(),
        );
        typed.google.insert(
            "invalid".to_string(),
            omnesagent_config::schema::GoogleTranscriptionProviderConfig::default(),
        );
        typed.local_whisper.insert(
            "invalid".to_string(),
            omnesagent_config::schema::LocalWhisperTranscriptionProviderConfig::default(),
        );
    ...
    async fn typed_registration_defaults_and_language_hints() {
        ...
        let base = omnesagent_config::schema::TranscriptionProviderConfig {
        ...
        let mut openai = OpenAiWhisperProvider::from_typed_config(
            "default",
            &omnesagent_config::schema::OpenAiTranscriptionProviderConfig {
                base: base.clone(),
        ...
        let mut deepgram = DeepgramProvider::from_typed_config(
            "default",
            &omnesagent_config::schema::DeepgramTranscriptionProviderConfig {
                base: base.clone(),
                model: Some("\t".to_string()),
            },
        )
        ...
        let google = GoogleSttProvider::from_typed_config(
            "default",
            &omnesagent_config::schema::GoogleTranscriptionProviderConfig {
                base: omnesagent_config::schema::TranscriptionProviderConfig {
    ...
    fn local_whisper_config(url: &str) -> omnesagent_config::schema::LocalWhisperConfig {
        omnesagent_config::schema::LocalWhisperConfig {
            url: url.to_string(),
    ...
    fn local_whisper_default_uses_serde_defaults_not_rust_zero() {
        let cfg = omnesagent_config::schema::LocalWhisperConfig::default();
        assert_eq!(
            cfg.max_audio_bytes,
            25 * 1024 * 1024,
    ...
    fn local_whisper_provider_accepts_config_init_default_after_url_and_token_filled() {
        // Mirrors the post-init state from a `omnesagent config init
        ...
        let cfg = omnesagent_config::schema::LocalWhisperConfig {
            url: "http://127.0.0.1:9999/v1/transcribe".to_string(),
            bearer_token: Some("test-token".to_string()),
            ..omnesagent_config::schema::LocalWhisperConfig::default()
        };
    ...
    fn typed_local_whisper_default_uses_serde_defaults_not_rust_zero() {
        ...
        let cfg = omnesagent_config::schema::LocalWhisperTranscriptionProviderConfig::default();
        assert_eq!(
            cfg.max_audio_bytes,
            25 * 1024 * 1024,
    ...
    fn typed_local_whisper_provider_accepts_default_after_uri_and_token_filled() {
        ...
        let cfg = omnesagent_config::schema::LocalWhisperTranscriptionProviderConfig {
    ...
    fn local_whisper_serde_round_trip() {
        let scaffolded = omnesagent_config::schema::LocalWhisperConfig {
            url: "http://127.0.0.1:9999/v1/transcribe".to_string(),
            bearer_token: Some("test-token".to_string()),
            ..omnesagent_config::schema::LocalWhisperConfig::default()
        };
        ...
        let reloaded: omnesagent_config::schema::LocalWhisperConfig =
    ...
    ///    already created `config.toml` before any `omnesagent config`
    ...
    ///    `omnesagent config init <section>` handler makes
    ...
    ///    the `omnesagent config set <path> <value>` handler makes
    ...
    async fn local_whisper_config_init_preserves_transcription_section() {
        ...
        let initial = omnesagent_config::schema::Config {
        ...
        let salvage = omnesagent_config::migration::migrate_to_current_salvaged(&contents);
    ...
    async fn with_typed_providers_registers_dotted_alias_keys() {
        use omnesagent_config::providers::TranscriptionProviders;
