...
impl WeComChannel {
    ...
    fn http_client(&self) -> reqwest::Client {
        omnesagent_config::schema::build_runtime_proxy_client("channel.wecom")
    }
    ...
    pub fn is_user_allowed(&self, user_id: &str) -> bool {
        ...
        ::omnesagent_log::record!(TRACE, ::omnesagent_log::Event::new(module_path!(), ::omnesagent_log::Action::Note).with_attrs(::serde_json::json!({"channel": "wecom", "alias": self.alias, "user_id": user_id, "allowed": allowed})), "wecom allowlist decision");
        allowed
    }
}

impl ::omnesagent_api::attribution::Attributable for WeComChannel {
    fn role(&self) -> ::omnesagent_api::attribution::Role {
        ::omnesagent_api::attribution::Role::Channel(::omnesagent_api::attribution::ChannelKind::WeCom)
    }
    fn alias(&self) -> &str {
        &self.alias
    }
