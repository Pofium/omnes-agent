...
pub use omnesagent_config::scattered_types::GmailPushConfig;
...
impl ::omnesagent_api::attribution::Attributable for GmailPushChannel {
    fn role(&self) -> ::omnesagent_api::attribution::Role {
        ::omnesagent_api::attribution::Role::Channel(
            ::omnesagent_api::attribution::ChannelKind::GmailPush,
        )
    }
    fn alias(&self) -> &str {
        &self.alias
...
impl Channel for GmailPushChannel {
    ...
    async fn send(&self, message: &SendMessage) -> Result<()> {
        ...
        let subject = message.subject.as_deref().unwrap_or("OmnesAgent Message");
