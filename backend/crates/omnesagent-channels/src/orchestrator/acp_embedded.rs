...
//! Implementation lives in `omnesagent_tools::embedded_resource` so MCP and ACP
//! share one helper without `omnesagent-tools` depending on this crate.

pub use omnesagent_tools::embedded_resource::{
