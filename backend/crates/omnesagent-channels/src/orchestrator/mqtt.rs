...
use omnesagent_config::schema::MqttConfig;
use omnesagent_runtime::sop::audit::SopAuditLogger;
use omnesagent_runtime::sop::dispatch::SopIngress;
...
pub async fn run_mqtt_sop_listener(
    ...
    omnesagent_runtime::health::mark_component_ok("mqtt");
    ...
    loop {
        match eventloop.poll().await {
            ...
            Err(e) => {
                omnesagent_runtime::health::mark_component_error("mqtt", e.to_string());
                ::omnesagent_log::record!(
                    WARN,
                    ::omnesagent_log::Event::new(module_path!(), ::omnesagent_log::Action::Note)
