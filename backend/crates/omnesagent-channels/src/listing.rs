...
use omnesagent_config::schema::ChannelsConfig;
use omnesagent_config::traits::ChannelInfo;
...
const CHANNEL_COMPILE_SPECS: &[ChannelCompileSpec] = &[
    ...
    ChannelCompileSpec {
        ...
        type_keys: &["plugin"],
        compiled: omnesagent_runtime::plugin_runtime::WASM_PLUGIN_SUPPORT_COMPILED,
    },
    ChannelCompileSpec {
        schema_name: None,
...
mod tests {
    ...
    fn channel_type_compilation_tracks_enabled_features() {
        ...
        assert_eq!(
            ...
            omnesagent_runtime::plugin_runtime::WASM_PLUGIN_SUPPORT_COMPILED
        );
    }
    ...
    fn configured_uncompiled_channels_uses_schema_config_status() {
        ...
        cfg.slack.insert(
            "default".to_string(),
            omnesagent_config::schema::SlackConfig::default(),
        );
        cfg.plugin.insert(
            "mail".to_string(),
    ...
    fn channel_compile_specs_cover_schema_channel_types() {
        let out_of_scope = BTreeSet::from([
            ...
            // `omnesagent-channels` Channel implementation with its own feature.
            "voice_duplex",
        ]);

        for channel_type in omnesagent_config::schema::v2::V3_CHANNEL_TYPES {
