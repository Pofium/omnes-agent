...
impl BlueskyChannel {
    ...
    fn http_client(&self) -> reqwest::Client {
        omnesagent_config::schema::build_runtime_proxy_client("channel.bluesky")
    }
...
impl ::omnesagent_api::attribution::Attributable for BlueskyChannel {
    fn role(&self) -> ::omnesagent_api::attribution::Role {
        ::omnesagent_api::attribution::Role::Channel(
            ::omnesagent_api::attribution::ChannelKind::Bluesky,
        )
    }
    fn alias(&self) -> &str {
        &self.alias
