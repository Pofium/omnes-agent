...
pub(crate) fn localized_lifecycle_progress(event: ProgressEvent) -> String {
    omnesagent_runtime::i18n::get_required_cli_string(lifecycle_progress_fluent_key(event))
}
...
pub const BLOCK_KIT_PREFIX: &str = "__OMNESAGENT_BLOCK_KIT__";
...
pub fn parse_approval_reply(
    text: &str,
) -> Option<(String, omnesagent_api::channel::ChannelApprovalResponse)> {
...
pub(crate) fn build_yesno_approval_prompt(
    ...
    let heading = omnesagent_runtime::i18n::get_required_cli_string("channel-approval-heading-shout");
    let tool_label = omnesagent_runtime::i18n::get_required_cli_string("channel-approval-tool-label");
    let args_label = omnesagent_runtime::i18n::get_required_cli_string("channel-approval-args-label");
    ...
    let reply = omnesagent_runtime::i18n::get_required_cli_string_with_args(
...
pub(crate) struct PendingApproval {
    pub(crate) sender: tokio::sync::oneshot::Sender<omnesagent_api::channel::ChannelApprovalResponse>,
...
pub fn conversation_history_key(msg: &omnesagent_api::channel::ChannelMessage) -> String {
    match &msg.thread_ts {
        Some(tid) => format!(
            "{}_{}_{}_{}",
