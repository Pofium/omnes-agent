...
pub use omnesagent_config::scattered_types::ClawdTalkConfig;
...
impl ::omnesagent_api::attribution::Attributable for ClawdTalkChannel {
    fn role(&self) -> ::omnesagent_api::attribution::Role {
        ::omnesagent_api::attribution::Role::Channel(
            ::omnesagent_api::attribution::ChannelKind::ClawdTalk,
        )
    }
    fn alias(&self) -> &str {
        &self.alias
