...
pub fn discord_slash_specs_from_skills(
    skills: &[omnesagent_runtime::skills::Skill],
) -> Vec<DiscordSlashCommandSpec> {
    let mut candidates: Vec<&omnesagent_runtime::skills::Skill> = skills
        .iter()
...
fn map_skill_slash_options(skill: &omnesagent_runtime::skills::Skill) -> Vec<OptionSpec> {
...
fn warn_drop_option(skill: &omnesagent_runtime::skills::Skill, option: &str, reason: &str) {
    ::omnesagent_log::record!(
        WARN,
        ::omnesagent_log::Event::new(module_path!(), ::omnesagent_log::Action::Note)
            .with_outcome(::omnesagent_log::EventOutcome::Unknown)
...
"#;
        ...
        let (skills, _) = omnesagent_runtime::skills::load_skills_from_directory(tmp.path(), false);
    ...
    fn map_drops_unknown_kinds_and_sorts_required_first() {
        let skill = omnesagent_runtime::skills::Skill {
            name: "s".to_string(),
            description: "d".to_string(),
            description_localizations: Default::default(),
            version: "0".to_string(),
            ...
            prompts: Vec::new(),
            slash_options: vec![
                omnesagent_runtime::skills::SkillSlashOption {
                    name: "opt".to_string(),
    ...
    fn sso(name: &str, kind: &str) -> omnesagent_runtime::skills::SkillSlashOption {
        omnesagent_runtime::skills::SkillSlashOption {
            name: name.to_string(),
            description: "d".to_string(),
            description_localizations: Default::default(),
    ...
    fn skill_with(
        slash_options: Vec<omnesagent_runtime::skills::SkillSlashOption>,
    ...
    fn map_drops_a_nonparsing_numeric_choice() {
        ...
        o.choices = vec![
            omnesagent_runtime::skills::SkillSlashChoice {
                name: "ok".to_string(),
                value: "10".to_string(),
            },
            omnesagent_runtime::skills::SkillSlashChoice {
