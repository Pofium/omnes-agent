...
use std::path::Path;
use omnesagent_api::model_provider::{ChatMessage, ConversationMessage, ToolCall, ToolResultMessage};
use omnesagent_api::plan::PlanEntry;
use omnesagent_log::{Action, EventOutcome};
...
impl AcpSessionStore {
    ...
    /// values are used at the matching `omnesagent_log::record!` call site.
    pub fn append_event(
        &self,
        session_uuid: &str,
        action: Action,
