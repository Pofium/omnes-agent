...
# omnesagent-docs-translations submodule (docs/book/po). Cuts the v{version} tag
...
#
# Requires push access to omnesagent-labs/omnesagent-docs-translations. The submodule
