...
const positives = [
  ...
  ['hardware', 'crates/omnesagent-api/src/peripherals_traits.rs'],
  ['hardware', 'firmware/esp32-ui/src/main.rs'],
];
const negatives = [
  ['cli', 'src/memory/mod.rs'],
  ['cli', 'crates/omnesagent-memory/src/cli.rs'],
  ['hardware', 'src/peripherals/driver.rs'],
  ['hardware', 'crates/omnesagent-api/src/channel.rs'],
  ['hardware', 'crates/omnesagent-runtime/src/agent/history.rs'],
