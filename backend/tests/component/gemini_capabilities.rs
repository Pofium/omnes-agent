...
use omnesagent::providers::create_model_provider_with_url;
use omnesagent::providers::traits::ModelProvider;
...
fn gemini_convert_tools_returns_prompt_guided() {
    use omnesagent::providers::traits::ToolsPayload;
    use omnesagent::tools::ToolSpec;
