...
use omnesagent::providers::compatible::AuthStyle;
use omnesagent::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use omnesagent::providers::compatible::OpenAiCompatibleModelProvider;
