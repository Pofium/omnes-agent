...
use omnesagent::providers::compatible::{AuthStyle, OpenAiCompatibleModelProvider};
use omnesagent::providers::{
...
fn factory_resolves_openai_codex_provider() {
    let options = omnesagent::providers::ModelProviderRuntimeOptions::default();
