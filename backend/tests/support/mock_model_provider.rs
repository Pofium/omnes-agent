...
use omnesagent::providers::traits::{ChatMessage, TokenUsage};
use omnesagent::providers::{ChatRequest, ChatResponse, ModelProvider, ToolCall};
...
impl ::omnesagent_api::attribution::Attributable for TraceLlmModelProvider {
    fn role(&self) -> ::omnesagent_api::attribution::Role {
        ::omnesagent_api::attribution::Role::Provider(
            ::omnesagent_api::attribution::ProviderKind::Model(
                ::omnesagent_api::attribution::ModelProviderKind::Custom,
