...
use omnesagent::channels::{Channel, ChannelMessage, SendMessage};
...
impl ::omnesagent_api::attribution::Attributable for MatrixTestChannel {
...
impl ::omnesagent_api::attribution::Attributable for MinimalChannel {
    fn role(&self) -> ::omnesagent_api::attribution::Role {
        ::omnesagent_api::attribution::Role::Channel(
            ::omnesagent_api::attribution::ChannelKind::Webhook,
        )
