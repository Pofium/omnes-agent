...
class _DesktopSettingsDialogState extends State<DesktopSettingsDialog> {
                  ...
                  Expanded(
                    child: ListView(
                      ...
                      children: [
                        ...
                        _buildNavItem('stt', DesktopI18n.tr('Голосовой ввод', 'Voice input'), Icons.mic_none),
  ...
  String _getSectionTitle(String section) {
    switch (section) {
      ...
      case 'stt':
        return DesktopI18n.tr('Голосовой ввод и STT (Handy / Whisper)', 'Voice Input & STT (Handy / Whisper)');
      case 'channels':
  ...
  Widget _buildCurrentSectionContent() {
    switch (selectedSection) {
      ...
      case 'stt':
        return VoiceSettingsSection(httpClient: _httpClient);
      default:
        return _buildGeneralSection();
    }
  }
  ...
  Widget _buildGeneralSection() {
    return Column(
      ...
      children: [
        ...
        _buildSettingCard(
          title: DesktopI18n.tr('Сворачивать в трей при закрытии', 'Minimize to tray on close'),
          subtitle: DesktopI18n.tr(
            'При нажатии на крестик (закрытие окна) приложение сворачивается в системный трей и продолжает работу в фоновом режиме.',
            'When clicking the close button, minimize to system tray and keep running in background.',
          ),
          control: Switch(
