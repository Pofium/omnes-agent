  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            tooltip: Strings.llmProviders.tr,
            icon: const Icon(Icons.memory_rounded),
            onPressed: () => Get.toNamed(Routes.llmProvidersScreen),
          ),
          IconButton(
            tooltip: Strings.selectAgent.tr,
            icon: const Icon(Icons.smart_toy_outlined),
            onPressed: () => AgentPickerDialog.show(context),
          ),
          IconButton(
            tooltip: Strings.settings.tr,
        ...
        child: ListView(
          ...
          children: [
            ...
            _buildFeatureCard(
              ...
              title: Strings.chatWithAgent.tr,
              subtitle: Strings.chatWithAgentSubtitle.tr,
              badge: 'LIVE WS',
            ...
            _buildFeatureCard(
              ...
              title: Strings.projectsAndFiles.tr,
              subtitle: Strings.projectsSubtitle.tr,
            ...
            _buildFeatureCard(
              ...
              title: Strings.sessionHistory.tr,
              subtitle: Strings.sessionsSubtitle.tr,
            ...
            _buildFeatureCard(
              ...
              title: Strings.agentMemory.tr,
              subtitle: Strings.memorySubtitle.tr,
            ...
            _buildFeatureCard(
              ...
              title: Strings.cronTasks.tr,
              subtitle: Strings.cronSubtitle.tr,
            ...
            _buildFeatureCard(
              ...
              title: Strings.costAndTokens.tr,
              subtitle: Strings.costSubtitle.tr,
            ...
            _buildFeatureCard(
              ...
              title: Strings.toolsAndSkills.tr,
              subtitle: Strings.toolsSubtitle.tr,
            ...
            _buildFeatureCard(
              ...
              title: Strings.skills.tr,
              subtitle: 'Установленные пакеты процедур агента',
            ...
            _buildFeatureCard(
              ...
              iconColor: const Color(0xFF00E5FF),
              title: Strings.systemStatus.tr,
              subtitle: Strings.systemStatusSubtitle.tr,
              badge: 'HEALTH',
      ...
      child: Row(
        children: [
          ...
          TextButton(
            ...
            onPressed: () => AgentPickerDialog.show(context),
            child: Text(Strings.change.tr, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
