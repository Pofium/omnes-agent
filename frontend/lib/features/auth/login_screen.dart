import 'package:omagent_front/utils/custom_style.dart';
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: Button(
                  onClick: () => controller.createBTN(context),
                  child: Text(
                    Strings.create.tr,
              ...
              Expanded(
                child: Button(
                  onClick: () => controller.loginBTN(context),
